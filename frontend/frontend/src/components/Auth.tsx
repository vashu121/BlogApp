...
import { SignupInput } from "@vaibhav121/medium-comon";
    ...
    return <div className="h-screen flex justify-center flex-col">
        <div className="flex justify-center">
            <div>
                ...
                <div className="pt-8">
                    {type === "signup" ? <LabelledInput label="Name" placeholder=" Vaibhav Maurya..." onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
                            name: e.target.value
                        })
                    }} /> : null}
                    <LabelledInput label="Username" placeholder="vashumaurya121@gmail.com" onChange={(e) => {
                        setPostInputs({
                            ...postInputs,
